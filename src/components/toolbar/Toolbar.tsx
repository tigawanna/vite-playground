...
export const Toolbar: React.FC<ToolbarProps> = () => {
  ...
  return (
    <div className="w-full h-10 flex justify-between items-center">
        ...
        <div className="m-1 w-fit h-full p-1 flex justify-center items-center ">
          <Link to="/">
            <div className="w-fit p-1 mx-5 flex justify-center items-centertext-white  ">
              <TheIcon Icon={AiOutlineHome} size="25" color="" iconstyle="" />
            </div>
          </Link>
        </div>
      </div>
      ...
      <div
        className="min-w-[10%] md:px-2 h-full flex justify-center items-center gap-1 md:gap-2
      ...
      >
        ...
        <div
          className="w-full px-1 h-full flex justify-center items-center
      hover:text-rose-700"
        >
